export const Privacy = () => {
  return (
    <div className="mx-auto w-[75%] space-y-4 py-8">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Study Snap.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Study Snap, accessible from{" "}
            <a
              href="https://studysnap.vercel.app/"
      ...
      <ul>
        <li>By email: akshatdubey0808@gmail.com</li>
      </ul>
    </div>
  );
};
