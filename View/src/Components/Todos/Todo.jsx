...
export const Todo = ({ item, setItems, user, handleUpdateClick }) => {
  ...
  return (
    ...
    >
      <div className="select-none flex items-center font-medium transition-colors text-md min-h-10 text-black px-3 rounded-lg bg-gray-200 hover:bg-gray-300 active:bg-slate-200">
